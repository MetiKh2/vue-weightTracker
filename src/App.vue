...
watch(weights,async (newWeights) => {
...
<template>
  <main>
    ...
    <form @submit.prevent="addWeight">
      ...
      <button type="button" @click="clear" style="padding: 10px;border-left: 1px solid black;">Clear</button>
    </form>
